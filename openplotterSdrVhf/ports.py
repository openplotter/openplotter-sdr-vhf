...
class Ports:
	...
	def usedPorts(self):
		...
		if self.ais:
			...
			usedPorts.append({'id':'rtl-ais-web', 'description':_('SDR AIS Web Viewer'), 'data':[], 'type':'TCP', 'mode':'server', 'address':'localhost', 'port':'8100', 'editable':'0'})
